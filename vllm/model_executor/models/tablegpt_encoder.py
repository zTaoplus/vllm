...
def dummy_seq_data_for_contrastive_tablegpt(
    hf_config: TableGPTContrastiveConfig, seq_len: int, num_tables: int = 1
):
...
def dummy_data_for_contrastive_tablegpt(
    ...
    seq_data = dummy_seq_data_for_contrastive_tablegpt(
        hf_config, ctx.model_config.max_model_len, num_tables
    )

    mm_data = dummy_tabledata_for_contrastive_tablegpt(
        ctx.model_config, table_max_rows, table_max_cols, num_tables
    )
