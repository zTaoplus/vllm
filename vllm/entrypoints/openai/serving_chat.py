...
def _table_tokenizer_insert(prompt: str,
    ...
    Returns:
        torch.Tensor: The tokenized input prompt as a tensor of input IDs. 
                      You need to move to the correct device before using it.
        ...
        try:
            ...
            if isinstance(mm_data, dict) and "table" in mm_data:
                ...
                prompt_inputs = TextTokensPrompt(
                    prompt_token_ids=table_input_ids.tolist(), prompt=prompt)
